...
const RoughIndex = memo(() => (
  <div className="rough-antd">
    <div className="chart-module">
      ...
      />
      <ChartProvider height={400} width={480} data={chartData}>
        <XAxis dataKey="name" />
        <YAxis />
        <LineSeries
          dataKey="value1"
          options={{ stroke: colors[0], strokeWidth: 2 }}
        />
        <LineSeries
          dataKey="value2"
          options={{ stroke: colors[3], strokeWidth: 2 }}
        />
        <Tooltip />
      </ChartProvider>
    </div>
    ...
    >
      ...
      <Circle diameter={2.8} x={234.4} y={189.2} />
      <Path d="M263,182.8c-3.5,0-6.4,2.9-6.4,6.4c0,3.5,2.9,6.4,6.4,6.4c3.5,0,6.4-2.9,6.4-6.4C269.4,185.6,266.6,182.8,263,182.8z" />
      <Circle diameter={2.8} x={263} y={189.2} />
      <Path d="M275,171.4c-2.8-0.7-5.2-3-6.3-5.1l-3.9-7.4c-1.1-2.1-3.9-3.8-6.3-3.8h-22.6c-2.4,0-5,1.8-5.7,4.1l-2.4,7c-0.2,0.9-1.8,5.5-5,5.5c-2.4,0-5,3.1-5,5.5v8.2c0,2.4,1.9,4.3,4.3,4.3h4.5c0-0.2,0-0.3,0-0.5c0-4.3,3.5-7.8,7.8-7.8c4.3,0,7.8,3.5,7.8,7.8c0,0.2,0,0.3,0,0.5h13.1c0-0.2,0-0.3,0-0.5c0-4.3,3.5-7.8,7.8-7.8s7.8,3.5,7.8,7.8c0,0.2,0,0.3,0,0.5h8.1c2.4,0,4.3-1.9,4.3-4.3v-6.5C283.2,172,277.3,172,275,171.4z" />
